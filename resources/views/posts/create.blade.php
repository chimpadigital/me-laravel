...
<div class="card">
		...
		<div class="card-body">
			<form id="formulario" action="{{ route('admin.post.store') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						...
						<input class="form-control" type="summary" name="summary" required value="{{ old('summary') }}">
				...
				<div class="form-group">
					...
					<div id="summernote" class="summernote">{!! old('description') !!}</div>
